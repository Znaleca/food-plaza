...
const FeaturesPage = () => {
  return (
    <div className="w-full bg-neutral-900 text-white p-8 flex flex-col items-center">

      {/* Header Section */}
      <div className="mt-8 sm:mt-12 text-center mb-6 px-4">
      ...
      {/* Features Section */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 max-w-5xl w-full text-center mb-10">

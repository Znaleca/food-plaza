...
const ReservationTicket = ({ booking, showActions = true }) => {
  ...
  return (
    <div className="bg-neutral-900 border border-pink-600 rounded-xl p-6 text-center text-white hover:bg-neutral-950 transition-all duration-300 max-w-3xl mx-auto font-sans leading-relaxed">
      {/* Decorative Line */}
      ...
      {/* Intro Text */}
      <p className="mb-6 text-sm font-light max-w-xl mx-auto">
      ...
      {/* Agreement Notice */}
      <div className="text-xs text-gray-300 font-extralight max-w-xl mx-auto text-left">
        <p>

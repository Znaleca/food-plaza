    ...
    <div className="relative z-0 bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col transition-all transform hover:scale-105 hover:shadow-2xl border border-yellow-400 w-full sm:w-[400px] md:w-[450px] lg:w-[500px] mx-auto mb-6">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-6 pt-4 border-t border-gray-300">
          <Link
            href={`/rooms/${room.$id}`}
            className="block text-center bg-yellow-400 text-white py-3 px-6 rounded-full shadow-md text-lg font-semibold tracking-wide transition-all hover:bg-blue-400 hover:shadow-lg transform hover:scale-105"
          >
            Order Here
          </Link>
        </div>

...
const SpaceCard = ({ room, priority = false, averageRating = 0, reviewCount = 0 }) => {
  ...
  return (
    <Link href={`/rooms/${room.$id}`} passHref>
      <div className="bg-neutral-900 border h-auto border-pink-600 hover:border-pink-400 rounded-3xl overflow-hidden mb-4 transition-colors duration-300 w-full max-w-sm cursor-pointer">
        {/* Image */}
